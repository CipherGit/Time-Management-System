...
<div class="container">
	...
	<div class="jumbotron">
	  ...
	  <p><a class="btn btn-primary btn-lg" href="index.jsp" role="button">Give it a try!</a></p>
	</div>
</div>
